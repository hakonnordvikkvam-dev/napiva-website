...
export const metadata: Metadata = {
  title: "Terms of Service | Napiva",
  description: "Terms of Service for Napiva - AI Automation Agency",
}
      ...
      <div className="mx-auto max-w-4xl px-6 sm:px-8 py-16 lg:py-24">
        <div className="glass-card border border-border/50 rounded-3xl p-8 sm:p-12 lg:p-16">
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-6 text-muted-foreground leading-relaxed">
            <p>
              By using the website, visitors agree to use it responsibly.
            </p>
            
            <p>
              Submitting an inquiry does not create a client relationship or guarantee services.
            </p>
            
            <p>
              Project scope, timelines, and deliverables are agreed separately in writing.
            </p>
            
            <p>
              Napiva is not responsible for issues caused by third-party platforms or services.
            </p>
